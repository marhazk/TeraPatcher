...
namespace TeraLauncher
{
    ...
    {
        //Patch Ver
        public static String GetPatchVer(String defaultValue = "1")
        {
            String _patchVer = defaultValue;
            try
            {
                _patchVer = IniReader.ReadValue("Launcher", "patchVer", LoginForm.configFile);
                if (_patchVer == "")
                {
                    _patchVer = defaultValue;
                    IniReader.WriteValue("Launcher", "patchVer", "1", LoginForm.configFile);
                }
            }
            catch (Exception /*ex*/)
            {
        ...
        //UpdateButton-normal
        public static String GetUpdateButtonNormal(String defaultValue = "btn-update-nm.png")
        {
            String _btn_update_nm = defaultValue;
            try
            {
                _btn_update_nm = IniReader.ReadValue("Skin", "btnUpdateNm", LoginForm.configFile);
                if (_btn_update_nm == "")
                {
                    _btn_update_nm = defaultValue;
                    IniReader.WriteValue("Skin", "btnUpdateNm", "btn-update-nm.png", LoginForm.configFile);
                }
            }
            catch (Exception /*ex*/)
            {
            }
            return _btn_update_nm;
        }
        //UpdateButton-hover
        public static String GetUpdateButtonHover(String defaultValue = "btn-update-hv.png")
        {
            String _btn_update_hv = defaultValue;
            try
            {
                _btn_update_hv = IniReader.ReadValue("Skin", "btnUpdateHv", LoginForm.configFile);
                if (_btn_update_hv == "")
                {
                    _btn_update_hv = defaultValue;
                    IniReader.WriteValue("Skin", "btnUpdateHv", "btn-update-hv.png", LoginForm.configFile);
                }
            }
            catch (Exception /*ex*/)
            {
            }
            return _btn_update_hv;
        }
        //CloseButton-normal
